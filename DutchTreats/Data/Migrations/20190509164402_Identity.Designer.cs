...
namespace DutchTreats.Migrations
{
    ...
    [Migration("20190509164402_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, OrderDate = new DateTime(2019, 5, 9, 16, 44, 1, 977, DateTimeKind.Utc), OrderNumber = "12345" }
                    );
                });
            ...
            modelBuilder.Entity("DutchTreats.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("DutchTreats.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DutchTreats.Data.Entities.StoreUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
